...
describe("Pinyinify", () => {
    ...
    it("selects the correct pronunciation for 多音字", () => {
        ...
        expect("我觉得睡觉是很重要的。我睡了一个好觉有很好的感觉。").becomes("wǒ juéde shuìjiào shì hěn zhòngyào de. wǒ shuì le yīgè hǎo jiào yǒu hěn hǎo de gǎnjué.");
        ...
        expect("不要应该睡觉时不睡觉。").becomes("bùyào yīnggāi shuìjiàoshí bù shuìjiào.");
    });
